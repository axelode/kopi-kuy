...
const OurTeam = () => {
    return (
        <div className="w-full min-h-screen flex flex-col justify-center items-center p-8 bg-[#EEE6DC] shadow-inner">
            ...
            <div className='w-full flex items-center justify-between gap-4 mt-16'>
                {team.map((data, index) => (
                    <ScrollAnimation key={index} animateIn={index % 2 === 0 ? "fadeInUp" : "fadeInDown"} animateOut={index % 2 === 0 ? "fadeOutUp" : "fadeOutDown"} delay={index * 500}>
