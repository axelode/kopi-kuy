...
const Review = () => {
    return (
        <div className="relative w-full min-h-screen flex flex-col justify-center items-center p-8 bg-white">
            <img
            ...
            <div className='flex flex-col justify-center items-center z-10'>
                ...
                <div className='w-full flex flex-wrap justify-between mt-16'>
                    {review.map((data, index) => (
                        <ScrollAnimation key={index} animateIn='fadeInDown' animateOut='fadeOutUp' delay={index * 500} className='w-[24%] flex flex-col gap-2 p-6 bg-white shadow-xl rounded-xl'>
