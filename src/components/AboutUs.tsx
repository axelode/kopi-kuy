...
const AboutUs = () => {
    return (
        <div className='w-full min-h-screen flex flex-col justify-center items-center gap-4 text-center p-8'>
            ...
            <ScrollAnimation animateIn="zoomIn" animateOut="zoomOut" className="flex justify-center items-center">
                <img
                    ...
                    width={"100%"}
                    className='w-6/12 rounded-xl hover:scale-110 transition-transform duration-300 ease-in-out'
                />
            </ScrollAnimation>
